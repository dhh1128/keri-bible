...
**One notable silence, and its resolution.** [#1627](https://github.com/WebOfTrust/keripy/discussions/1627) *ACDC Presentation Architectures* — Sam's newest architecture discussion, updated 2026-09-01 — does not mention presentation or usage registries at all. On the written record alone, whether that meant settled, parked or superseded was not determinable. **It is none of those: the work is intended.** On a call on 2026-09-01 Sam named observers, registrars and presentation registries together as things that need to be built (Daniel Hardman, first-hand, same day).

**That report is a new provenance class for this corpus, and a weak one in form.** There is no recording, no transcript, and no approximate wording — only a first-hand account of the substance. Compare `raw/14`, whose edited auto-captions at least preserve near-wording. Use it for **status and intent only**; never as a quotation, and never as evidence about any design detail. It closes the "is this alive" question and nothing else.
...
3. ~~**Is the ten-month silence meaningful?**~~ **Resolved: no.** Sam named presentation registries as work to be built on a call on 2026-09-01 (§0). The written record understates the design's standing, which is a caution about this corpus generally: a dead discussion thread is not evidence of a dead idea.
